...
try:
    ...
    from hardware.accelerometer import AccelerometerSensor
    from hardware.magnetometer import MagnetometerSensor
    from hardware.thermal import ThermalSensor
    from hardware.electromagnetic import EMFieldSensor
    from hardware.optical import OpticalSensor
    from hardware.acoustic import AcousticSensor
    from hardware.capacitive import CapacitiveSensor
    from hardware.timing import TimingSensor
    from hardware.computational import ComputationalSensor
    from hardware.network import NetworkSensor
    from hardware.storage import StorageSensor
except ImportError:
